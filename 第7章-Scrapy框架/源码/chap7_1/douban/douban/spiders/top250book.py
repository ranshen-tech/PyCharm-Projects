...
class DoubanSpider(scrapy.Spider):
    name='douban' #定义爬虫的名称，启动爬虫程序时使用
    allowed_domains=['book.douban.com/top250'] #定义充许爬虫爬取的域名
    start_urls=['https://book.douban.com/top250'] #定义起始的网址,告诉我们的爬虫程序应该从哪个网址开始爬取
    ...
    def parse(self, response):
        ...
        for tr in tr_tag:
            ...
            title=tr.find_all('a.txt')[1]['title'] #提取书名
